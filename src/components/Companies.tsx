  ...
  <section className="py-20 bg-gray-100" id="projects">
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          { name: 'TRINETIX / DELOITTE', description: 'Developed audits Deloitte\'s application using TypeScript, React, Microservices. Members of team (6 FE dev, 2 BE dev, 3 QA tester, 1 BA, 1 PM)' },
