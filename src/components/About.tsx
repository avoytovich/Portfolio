  ...
  <section className="py-20 bg-gray-100" id="about">
    <div className="container mx-auto px-4">
      ...
      <p className="text-gray-700 mb-6">
        I’m a Front-end (React) developer with 6 years in the IT industry and a passion for building web applications that are user-friendly, performant, and visually appealing.
      </p>
